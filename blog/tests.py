...
class TestView(TestCase):
    def setUp(self):
        ...
        self.user_kim = User.objects.create_user(username='kim', password='applebox')
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.user_chu.username.upper(), post_area.text)
    ...
    def test_create_post(self):
        ...
        # 로그인을 한다.
        self.client.login(username='chu', password='applebox')
        ...
        self.assertEqual(last_post.author.username, 'chu')
